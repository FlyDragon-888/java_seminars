...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Notebook> filteredLaptops = filterLaptops(laptops);
    ...
    private static List<Notebook> filterLaptops(List<Notebook> laptops) {
    ...
    private static void generateLaptops(List<Notebook> laptops) {
        laptops.add(new Notebook("Apple", "Macbook Air 2022", "Silver",
                "Apple M2", 8, 256, 13.3, true, false));
        laptops.add(new Notebook("Huawei", "MateBook D BoD-WDH9", "White",
                "Intel Core i5 1135G7",8, 512, 15.6, true, false));
        laptops.add(new Notebook("ASUS", "Vivobook M1502I", "Black",
                "AMD Ryzen 5 4600H", 16, 1000, 15.6, false, true));
        laptops.add(new Notebook("Acer", "Aspire 3 A315-23-R91S", "Silver",
                "AMD Ryzen 5 3500U", 8, 1000, 15.6, false, false));
        laptops.add(new Notebook("ASUS", "Vivobook Go 15 E510MA-BQ509W", "Blue",
                "Intel Celeron N4020", 4, 128, 14.4, true, false));
        laptops.add(new Notebook("Huawei", "MateBook D 16 RLEF-X", "Black",
                "Intel Core i7 12700H", 16, 512, 14.4, true, false));
        laptops.add(new Notebook("MSI", "Titan GT77 12UHS-208RU", "Black",
                "Intel Core i9 12900HX", 64, 3072, 17.3, true, true));
        laptops.add(new Notebook("Apple", "Macbook Pro 2021", "Space Gray",
